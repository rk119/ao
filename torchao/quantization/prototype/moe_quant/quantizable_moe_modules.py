...
class ConditionalFeedForwardAOQuantizable(nn.Module):
    def __init__(self, num_experts, hidden_dim, expert_dim, act_fn):
        super().__init__()
        self.w1 = nn.Parameter(torch.randn(num_experts, expert_dim, hidden_dim)) # E, I, D
        self.w2 = nn.Parameter(torch.randn(num_experts, hidden_dim, expert_dim)) # E, D, I
        self.w3 = nn.Parameter(torch.randn(num_experts, expert_dim, hidden_dim)) # E, I, D
